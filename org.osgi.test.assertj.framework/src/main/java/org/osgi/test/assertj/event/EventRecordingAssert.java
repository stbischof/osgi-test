...
public class EventRecordingAssert extends AbstractEventRecordingAssert<EventRecordingAssert, EventRecording> {
	 ...
	 */
	public static EventRecordingAssert assertThatServiceEvent(Runnable execute, Predicate<ServiceEvent> predicate,
		int timeout) throws Exception {
		return assertThat(execute, hasTypeAnd(ServiceEvent.class, predicate), timeout);
	}
	...
	public static EventRecordingAssert assertThatBundleEvent(Runnable execute, Predicate<BundleEvent> predicate,
		int timeout) throws Exception {
		return assertThat(execute, hasTypeAnd(BundleEvent.class, predicate), timeout);
	}
	 ...
	 * @param timeout - the time in that the matches must happened
	 */
	public static EventRecordingAssert assertThatFrameworkEvent(Runnable execute, Predicate<FrameworkEvent> predicate,
		int timeout) throws Exception {
		return assertThat(execute, hasTypeAnd(FrameworkEvent.class, predicate), timeout);
	}
	...
	public static EventRecordingAssert assertThat(Runnable execute, Predicate<Object> predicate, int timeout)
		...
		EventRecording awaitResult = EventRecording.record(bc, execute, predicate, timeout);
