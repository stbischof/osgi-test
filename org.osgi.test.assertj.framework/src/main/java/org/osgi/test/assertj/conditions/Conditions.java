...
import static org.osgi.test.assertj.conditions.Conditions.DictionaryConditions.servicePropertiesContained;
import static org.osgi.test.assertj.conditions.Conditions.ServiceReferenceConditions.objectClass;
import static org.osgi.test.assertj.conditions.Conditions.ServiceReferenceConditions.servicePropertiesHas;
...
public interface Conditions {
	...
	/**
	 * A Utility-Class thats Provides static methods to create
	 * {@link Conditions} for an {@link Bundle}
	 */
	interface BundleConditions {
		/**
		 * Creates a {@link Condition} to be met by an {@link Bundle}. Checking
		 * if a {@link Bundle} is <b>equal</b> an other Bundle.
		 * <p>
		 * Example:
		 *
		 * <pre>
		 ...
		 * </pre>
		 *
		 * @param serviceReferences - the expected serviceReferences that would
		 *            be checked against other {@link ServiceReference}s
		 * @return the Condition<br>
		 */
		static Condition<Bundle> sameAs(Bundle bundle) {
			Condition<Bundle> c = Descriptive.descriptive(bundle, (b1, b2) -> Objects.equals(b1, b2), "bundle equals");
			return c;
		}
	}
	...
	/**
	 * A Utility-Class thats Provides static methods to create
	 * {@link Conditions} for an {@link BundleEvent}
	 */
	interface BundleEventConditions {

		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a {@link Bundle} is <b>equal</b> the bundle of the
		 * {@link BundleEvent} that had a change occur in its lifecycle.
		 * <p>
		 * Example:
		 *
		 * <pre>
		...
		static Condition<BundleEvent> bundleEquals(Bundle bundle) {
			...
			return Mapped.mapped(BundleEvent::getBundle, "BundleEvent::getBundle", BundleConditions.sameAs(bundle));
		}

		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if the bundle of the {@link BundleEvent} that had a change
		 * occur in its lifecycle <b>is not null</b>.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 *
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if the bundle of the {@link BundleEvent} that had a change
		 * occur in its lifecycle <b>is null</b>.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 *
		 ...
		 * given {@link Bundle} <b>equals</b> the Bundle and the other given
		 ...
		 * </pre>
		 *
		 * @param typeMask - the typeMask that would be checked against the
		 *            bundle type of the {@link BundleEvent}
		 * @param bundle - the bundle that would be checked against the bundle
		 *            of the {@link BundleEvent}
		 * @param origin - the bundle that would be checked against the origin
		 *            of the {@link BundleEvent}
		 * @return the Condition
		 */
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a {@link Bundle} is <b>equal</b> the bundle of the
		 * {@link BundleEvent} that was the origin of the event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 *
		...
		static Condition<BundleEvent> originEquals(Bundle bundle) {
			...
			return Mapped.mapped(BundleEvent::getOrigin, "BundleEvent::getOrigin", BundleConditions.sameAs(bundle));
		}

		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if the bundle of the {@link BundleEvent} that was the origin
		 * of the event. <b>is not null</b>.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 *
		...
		static Condition<BundleEvent> originIsNull() {
			return Descriptive.descriptive((Bundle) null, (be, b) -> be.getOrigin() == b, "origin is");
		}

		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a type-mask <b>matches</b> the {@link BundleEvent} type
		 * of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		...
		static Condition<BundleEvent> type(final int expectedEventTypeMask) {
			return Descriptive.descriptive(expectedEventTypeMask,
				(be, mask) -> Bitmap.typeMatchesMask(be.getType(), mask), "type matches mask", //
				BundleEventType.BITMAP::maskToString, //
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a given type-mask <b>matches</b> the type <i>and</i> the
		 * given {@link Bundle} <b>equals</b> the Bundle of the of lifecyle
		 * event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		...
		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if the {@link BundleEvent} type <b>matches
		...
		/**
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.INSTALLED</b> <i>and</i> the given {@link Bundle}
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.LAZY_ACTIVATION</b> <i>and</i> the given
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.RESOLVED</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.STARTED</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.STARTING</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.STOPPED</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.STOPPING</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.UNRESOLVED</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
		 ...
		 * Creates a {@link Condition} to be met by an {@link BundleEvent}.
		 * Checking if a the type of the {@link BundleEvent} is
		 * <b>BundleEvent.UPDATED</b> <i>and</i> the given {@link Bundle}
		 * <b>equals</b> the Bundle of the of lifecyle event.
		 *
		 * <pre>
		 * List<BundleEvent> bundleEvents = null;
	...
	interface DictionaryConditions {
		static Condition<Dictionary<String, Object>> servicePropertiesContained(Dictionary<String, Object> dictionary) {
			return servicePropertiesContained(Dictionaries.asMap(dictionary));
		}

		static Condition<Dictionary<String, Object>> servicePropertiesContained(Map<String, Object> map) {
		...
		static Condition<Dictionary<String, Object>> servicePropertyContained(final String key, Object value) {
			return servicePropertiesContained(Dictionaries.dictionaryOf(key, value));
		}
	}
	...
	interface FrameworkEventConditions {
		...
		static Condition<FrameworkEvent> bundleEquals(Bundle bundle) {
			...
			return Mapped.mapped(FrameworkEvent::getBundle, "FrameworkEvent::getBundle",
				BundleConditions.sameAs(bundle));
		...
		static Condition<FrameworkEvent> throwableIsNull() {
			return Descriptive.descriptive((Throwable) null, (fe, ex) -> fe.getThrowable() == ex, "throwable is");
		}
		...
		static Condition<FrameworkEvent> throwableOfClass(final Class<? extends Throwable> throwableClass) {
			...
			Condition<FrameworkEvent> cond = Descriptive.descriptive((Class<? extends Throwable>) throwableClass,
				(fe, ex) -> fe.getThrowable()
					.getClass()
					.isAssignableFrom(ex),
				"throwable of class");
		...
		static Condition<FrameworkEvent> type(final int eventTypeMask) {
			...
			return Descriptive.descriptive(eventTypeMask, //
				(fe, mask) -> Bitmap.typeMatchesMask(fe.getType(), mask), "type matches mask", //
				FrameworkEventType.BITMAP::maskToString, //
	...
	interface ServiceEventConditions {
		 ...
		 * Checking if a given type-mask <b>matches</b> the type and the given
		 * Class<?> objectClass matches a objectClass of the serviceReference
		 * and given dictionary's entries are contained in the serviceProperties
		 * of the ServiceReverence of the {@link ServiceEvent}
		 *
		 * <pre>
		 * List<ServiceEvent> serviceEvents = null;
		 *
		 ...
		 * @param objectClass - the objectClass that would be tested against the
		 *            ServiceReference
		 * @param dictionary - the dictionary's entries that would be tested
		 *            against the ServiceReference serviceProperties
		 * @return the Condition
		 */
		static Condition<ServiceEvent> matches(int eventTypeMask, final Class<?> objectClass,
		 ...
		 * Checking if a given type-mask <b>matches</b> the type and the given
		 * Class<?> objectClass matches a objectClass of the serviceReference
		 * and given Map's entries are contained in the serviceProperties of the
		...
		static Condition<ServiceEvent> matches(int eventTypeMask, final Class<?> objectClass, Map<String, Object> map) {
			...
			Condition<ServiceEvent> cProperties = serviceReferenceHas(
				servicePropertiesHas(servicePropertiesContained(map)));
		...
		static Condition<ServiceEvent> serviceReferenceEquals(ServiceReference<?> serviceReference) {
			...
			return Mapped.mapped(ServiceEvent::getServiceReference, "ServiceEvent::getServiceReference",
				ServiceReferenceConditions.sameAs(serviceReference));
		}
		...
		static Condition<ServiceEvent> serviceReferenceHas(Condition<ServiceReference<?>> serviceReferenceCondition) {
			Condition<ServiceEvent> mc = Mapped.mapped(ServiceEvent::getServiceReference,
				"ServiceEvent to ServiceReference using ServiceEvent::getServiceReference", serviceReferenceCondition);
		...
		static Condition<ServiceEvent> serviceReferenceIsNull() {
			...
			return Descriptive.descriptive((ServiceReference<?>) null,
				(sericeEvent, serviceReference) -> sericeEvent.getServiceReference() == serviceReference,
				"serviceReference is");
		...
		static Condition<ServiceEvent> type(final int eventTypeMask) {
			...
			return Descriptive.descriptive(eventTypeMask, //
				(se, mask) -> Bitmap.typeMatchesMask(se.getType(), mask), "type matches mask", //
				ServiceEventType.BITMAP::maskToString, //
				se -> ServiceEventType.BITMAP.toString(se.getType()));
		}
		 ...
		 * Creates a {@link Condition} to be met by an {@link ServiceEvent}.
		 * Checking if type of {@link ServiceEvent} <b>matches</b>
		 * <b>ServiceEvent.MODIFIED</b> and the given Class<?> objectClass
		 ...
		 * Creates a {@link Condition} to be met by an {@link ServiceEvent}.
		 * Checking if type of {@link ServiceEvent} <b>matches</b>
		 * <b>ServiceEvent.MODIFIED_ENDMATCH</b> and the given Class<?>
		 * objectClass matches a objectClass of the ServiceReference.
		 *
		 * <pre>
		 * List<ServiceEvent> serviceEvents = null;
		 *
		 ...
		 * Creates a {@link Condition} to be met by an {@link ServiceEvent}.
		 * Checking if type of {@link ServiceEvent} <b>matches</b>
		 * <b>ServiceEvent.REGISTERED</b> and the given Class<?> objectClass
		 * matches a objectClass of the ServiceReference.
		 *
		 * <pre>
		 * List<ServiceEvent> serviceEvents = null;
		 ...
		 * Checking if type of {@link ServiceEvent} <b>matches</b>
		 * <b>ServiceEvent.REGISTERED</b> and the given Class<?> objectClass
		 * matches a objectClass of the ServiceReference and the given
		 * dictionary contained in the serviceProperties.
		 *
		 * <pre>
		 * List<ServiceEvent> serviceEvents = null;
		 *
	...
	interface ServiceReferenceConditions {
		...
		static Condition<ServiceReference<?>> sameAs(ServiceReference<?> serviceReference) {
			Condition<ServiceReference<?>> c = Descriptive.descriptive(serviceReference,
				(sr1, sr2) -> Objects.equals(sr1, sr2), "serviceReference equals");
			return c;
		}
		...
		static Condition<ServiceReference<?>> servicePropertiesHas(Condition<Dictionary<String, Object>> condition)
		 {
				return Mapped.mapped(sr -> Dictionaries.asDictionary((ServiceReference<?>) null),
					"ServiceReference to Dictionary", condition);
		 }
		 ...
		 * Condition<ServiceReference<?>> servicePropertiesIsNotNull() { return
		 * not(servicePropertiesIsNull()); }
		 */
